...
on
    dc.DiscussionID=ud.DiscussionID
join
(
    select
        DiscussionID,
    ...
    from
        GDN_Comment
    where
        DateInserted is not null
        and
        (
            DateDeleted is null
            or
            DateDeleted < DateInserted
        )
) c
on
    dc.DiscussionID=c.DiscussionID
    and
    (
        ud.DateLastViewed is null
        or
        ud.DateLastViewed < c.DateInserted
    )
")->resultArray();
